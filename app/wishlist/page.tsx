    ...
    <main className="min-h-screen bg-white px-4 py-16 text-[#151515] sm:px-8">
      <section className="mx-auto max-w-[1400px]">
        <div className="border-b border-neutral-100 pb-8">
          <p className="text-xs font-black uppercase tracking-[0.15em] text-neutral-400">Wishlist</p>
          <h1 className="mt-4 font-bembo text-4xl font-bold sm:text-5xl uppercase tracking-tight">Your saved pieces</h1>
          <p className="mt-4 max-w-xl text-sm leading-6 text-neutral-500">
            A curated list of your favorite vintage jerseys and historic sportswear.
          </p>
        </div>
        ...
        {wishlistItems.length === 0 ? (
          <div className="mt-16 text-center border border-neutral-200 py-16 px-6 max-w-2xl mx-auto">
            ...
            <h2 className="mt-4 text-lg font-black uppercase">Your wishlist is empty</h2>
            <p className="mt-2 text-sm text-neutral-500 leading-6">
              Explore our collection of vintage football archive pieces and click the heart icon on any item to save it here.
            </p>
            <Link
              href="/shop"
