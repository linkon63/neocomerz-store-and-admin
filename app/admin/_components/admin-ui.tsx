...
export function StatusToggle() {
  return (
    <span className="inline-flex h-8 w-14 items-center bg-blue-600 p-1">
      <span className="ml-auto h-6 w-6 bg-white" />
    </span>
  );
}
...
export function ProductThumb({ color }: { color: string }) {
  return (
    <div className="relative h-12 w-16 overflow-hidden bg-slate-50">
