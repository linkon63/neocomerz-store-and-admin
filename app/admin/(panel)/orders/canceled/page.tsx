  ...
  return (
    <>
      <PageHeader
        ...
        description="View and manage canceled or returned orders"
        action={
        ...
        <div className="flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white">
          ...
          <div key={search} className="flex-1 overflow-y-auto h-[600px] min-h-[400px] animate-in fade-in slide-in-from-left-2 duration-300">
            {isLoading ? (
              ...
              <div className="flex h-full items-center justify-center py-16 text-center text-slate-400">No canceled orders found.</div>
            ) : (
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-slate-200 bg-white p-4">
                <div className="flex items-center gap-3">
                  <span className="grid h-10 w-10 place-items-center rounded-full bg-rose-500 text-white shadow-lg shadow-rose-200">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="rounded-xl bg-blue-600 px-4 py-2 text-[13px] font-black text-white hover:bg-blue-700 transition-colors shadow-sm"
                  >
                    Restore Order
                  </button>
