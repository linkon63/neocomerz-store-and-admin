      ...
      <div className="presence-wrapper">
        ...
        >
          <div className="presence-content text-center">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-normal leading-tight inline-flex flex-col items-center gap-2">
              <span className="font-['Bembo_Std'] text-[#C6B485]">From the Gardens of Sylhet to </span>
              <span className="font-['Snell_Roundhand_LT_Std'] italic text-[#8E866B]">Tables Across the World</span>
            </h2>
