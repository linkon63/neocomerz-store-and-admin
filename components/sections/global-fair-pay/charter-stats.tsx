  ...
  return (
    <section className="w-full bg-[#212721] py-20 md:py-28 px-6 md:px-12 lg:px-24 text-white overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-16 relative z-10">
        ...
        <ScrollReveal delay={0} direction="up" className="w-full md:w-1/2 flex justify-center md:justify-start">
        ...
        <ScrollReveal delay={120} direction="up" className="w-full md:w-1/2 flex flex-col justify-center items-start text-left space-y-8">
