  ...
  return (
    <section className="w-full bg-white py-16 md:py-24 px-6 md:px-12 flex flex-col items-center justify-center text-center">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="w-14 h-14 rounded-full border border-zinc-200 flex items-center justify-center mb-8 bg-white shadow-xs">
          <img
        ...
        {/* Quote Text */}
        <p className="font-bembo text-2xl md:text-[32px] font-normal text-zinc-800 leading-[1.45] tracking-wide mb-8 max-w-3xl">
        ...
        {/* Author / Attribution */}
        <p className="font-bembo italic text-xs md:text-sm text-zinc-500 max-w-2xl leading-relaxed">
